...
server <- function(id, con, appData, genomicData, main_session) {
  moduleServer(id, function(input, output, session) {
    ...
    # observeEvent(current_sample_variants_genos(), {
    #   req(current_sample_variants_genos())
    #   print("aaa")
    #   print(utils::head(current_sample_variants_genos()))
    # })
    ...
    # observeEvent(current_sample_variants_ids(), {
    #   req(current_sample_variants_ids())
    #   print("aaa IDS")
    #   print(utils::head(current_sample_variants_ids()))
    # })
    ...
    # observeEvent(current_sample_variants_infos(), {
    #   req(current_sample_variants_infos())
    #   print("aaa tmp INFOS")
    #   print(utils::head(current_sample_variants_infos()))
    # })
    ...
    # observeEvent(current_sample_variants_impact_tmp(), {
    #   req(current_sample_variants_impact_tmp())
    #   print("current_sample_variants_impact_tmp")
    #   print(utils::head(current_sample_variants_impact_tmp()))
    # })
    ...
    current_sample_variants_impact <- reactive({
      ...
      if(appData$filters$trlist != "None"){
        ...
        print("using canonical transcripts")
    ...
    # observeEvent(current_sample_variants_MD(), {
    #   req(current_sample_variants_MD())
    #   print("current_sample_variants_MD")
    #   print(utils::head(current_sample_variants_MD()))
    # })
    ...
    # observeEvent(current_sample_variants_frequencies(), {
    #   req(current_sample_variants_frequencies())
    #   print("current_sample_variants_frequencies")
    #   print(utils::head(current_sample_variants_frequencies()))
    # })
    ...
    #   print("current_sample_variants_table")
